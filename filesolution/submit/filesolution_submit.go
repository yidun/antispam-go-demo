...
const (
	apiUrl     = "https://as-file.dun.163yun.com/v1/file/submit"
	version    = "v1.1"
...
func main() {
	params := url.Values{
		"url":         []string{"http://xxx.com/file/helloworld.doc"},
		...
		"publishTime": []string{"1234567890123"},
	}
	...
	if code == 200 {
		...
		fmt.Printf("SUCCESS: taskId=%s, dataId=%s", taskId, dataId)
	} else {
